...
from metamotivo.fb_cpr_aux import FBcprAgent, FBcprAgentConfig
...
class Workspace:
    ...
    def train_online(self) -> None:
        ...
        # Save
        with h5py.File(f'{self.work_dir}/checkpoint/buffer.hdf5', 'w') as hf:
            for key, value in replay_buffer['train'].storage.items():
...
if __name__ == "__main__":
    ...
    agent_config.train.aux_coeff = 1.0
    agent_config.train.reg_aux_coeff = 0.01  # 0.01 0.1, 1.0, 10.0
